...
int main() {
    ...
    LS.addStudent(21000000, "Okan Gungor");
    LS.addStudent(21000011, "Tahir Yurtsever");
    LS.addStudent(210012, "Aydamir Mirzayev");
    LS.addStudent(2100002, "Mert Duman");

    cout << endl;
    LS.addStudent(21000000, "Ryan Lochte");
    LS.addStudent(21000011, "Barry Kama");
